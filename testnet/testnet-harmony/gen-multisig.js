...
var RPC_URL = "https://endpoints.omniatech.io/v1/harmony/testnet-0/public"
...
async function genContractAddress(addressArray, keyArray, threshold) {
  ...
  console.log(`https://explorer.testnet.harmony.one/address/${safeAddress}`)
  console.log(`https://app.safe.global/hmy:${safeAddress}`)
