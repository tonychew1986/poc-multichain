...
var RPC_URL = "https://endpoints.omniatech.io/v1/aurora/testnet/public"
...
async function genContractAddress(addressArray, keyArray, threshold) {
  ...
  console.log(`https://testnet.aurorascan.dev/address/${safeAddress}`)
  console.log(`https://app.safe.global/aur:${safeAddress}`)
