...
var acct = root.derivePath("m/44'/2'/0'");
...
const child1 = root.derivePath("m/44'/2'/0'/0/0")
const child2 = root.derivePath("m/44'/2'/0'/0/1")
const child3 = root.derivePath("m/44'/2'/0'/0/2")
